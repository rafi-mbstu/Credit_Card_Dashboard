...
COPY cc_detail
FROM 'D:\Data Analyst\3. Power BI\Projects\Credit_Card_Financial_Dashboard-main\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\Data Analyst\3. Power BI\Projects\Credit_Card_Financial_Dashboard-main\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'D:\Data Analyst\3. Power BI\Projects\Credit_Card_Financial_Dashboard-main\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\Data Analyst\3. Power BI\Projects\Credit_Card_Financial_Dashboard-main\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;